    ...
    <div>
        <Card >
            ...
            <Row>
                <Col span="5">
                <Card dis-hover>
                    总收入:{{today.sale==null?0.0:(today.sale)}}元
                </Card>
                </Col>
                <Col span="5">
                <Card dis-hover>
                ...
                <Col span="5">
                <Card dis-hover>
                    故障数量：{{today.error==null?0:today.error}}起
                </Card>
                </Col>
                <Col span="4">
                <Card dis-hover>
                    退款：{{today.off==null?0:today.off}}笔
                </Card>
                </Col>
            </Row>
        </Card>
        ...
        <Row>
         ...
         <Row>
                <Col span="5">
                <Card dis-hover>
                    总收入:{{month.sale==null?0.0:month.sale}}元
                </Card>
                </Col>
                <Col span="5">
                <Card dis-hover>
                ...
                <Col span="4">
                <Card dis-hover>
                    退款：{{month.off==null?0:month.off}}笔
                </Card>
                </Col>
            </Row>
        </Card>
...
export default class Dashboard extends AbpBase {
  filters: any = {
    creationTime: [this.dateFormat('yyyy-MM-dd hh:mm:ss',new Date()),this.dateFormat('yyyy-MM-dd hh:mm:ss',new Date())]
  };
  get todaySale() {
  ...
  get payType() {
    var t= this.$store.state.dash.payType;
   return t;
  }
  get todayTop() {
  ...
  change() {
    ...
    this.$store.dispatch({
      ...
      data: {
        start: t != null ? t[0] : this.dateFormat('yyyy-MM-dd hh:mm:ss',new Date()),
        end: t != null ? t[1] : this.dateFormat('yyyy-MM-dd hh:mm:ss',new Date())
      }
    });
  }
  async created() {
