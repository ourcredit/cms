                    ...
                    <Row :gutter="16">
                        ...
                        <FormItem label="客户等级" prop="level">
                            <Select v-model="customer.level" filterable>
                                <Option v-for="item in customerLevel" :value="item.name" :key="item.name">{{ item.name
                                    }}</Option>
                            </Select>
                        </FormItem>
                        </Col>
                ...
                <Form ref="extendForm" label-position="top" :rules="extendRule" :model="extend">
                    ...
                    <Row :gutter="16">
                        ...
                        <FormItem label="月供" prop="monthBack">
                            <InputNumber style="width:160px" v-model="extend.monthBack" :step="1" :min="0" :formatter="value => ` ${value}     元`"></InputNumber>
                    ...
                    <Row :gutter="16">
                        ...
                        <FormItem label="垫资金额" prop="dianzijine">
                            <InputNumber style="width:160px" v-model="extend.dianzijine" :step="1" :min="0" :formatter="value => ` ${value}     元`"></InputNumber>
                        </FormItem>
                        </Col>
                    </Row>
                    <Row :gutter="16">
