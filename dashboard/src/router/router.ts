...
import(request: string): Promise < any> ;
  ...
  permission: "contract:modify",
  name: "contractmodify",
  component: () => System.import("../views/contract/modify.vue")
  }
  ]
  };
  export const appRouters: Array < any> = [{
    ...
    name: "sharelist",
    component: () => System.import("../views/customer/sharelist.vue")
    },
    {
    path: "force",
    meta: {
    ...
    permission: "share:list",
    name: "sharelog",
    component: () => System.import("../views/customer/sharelog.vue")
    }
    ]
    },
    {
