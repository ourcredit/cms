        ...
        public static List<MenuInfo> menuList = new ArrayList<MenuInfo>() {{
            ...
            add(new MenuInfo("设备管理", PermissionConst._devices.list, "", 1, new ArrayList<MenuInfo>() {{
                add(new MenuInfo("设备列表", PermissionConst._devices._device.list, "/device/list", 1, new ArrayList<MenuInfo>() {{
                    ...
                    add(new MenuInfo("添加次数", PermissionConst._devices._device.addcount, "", 2, null));
            ...
            add(new MenuInfo("货物管理", PermissionConst._products.list, "", 1, new ArrayList<MenuInfo>() {{
                ...
                add(new MenuInfo("上门", PermissionConst._products._door.list, "/product/door", 1, new ArrayList<MenuInfo>() {{
                    add(new MenuInfo("编辑上门服务", PermissionConst._products._door.modify, "", 2, null));
                    add(new MenuInfo("删除上门服务", PermissionConst._products._door.delete, "", 2, null));
                   // add(new MenuInfo("批量删除上门服务", PermissionConst._products._door.batch, "", 2, null));
            ...
            add(new MenuInfo("报表系统", PermissionConst._report.list, "", 1, new ArrayList<MenuInfo>() {{
                add(new MenuInfo("点位销量", PermissionConst._report._point.list, "/watch/device", 1, null));
                add(new MenuInfo("流水信息", PermissionConst._report._serial.list, "/watch/serial", 1, null));
                add(new MenuInfo("次数纪录", PermissionConst._report._count.list, "/watch/count", 1, null));
            ...
            add(new MenuInfo("运维系统", PermissionConst._operation.list, "", 1, new ArrayList<MenuInfo>() {{
                add(new MenuInfo("运维人员管理", PermissionConst._operation._staff.list, "/operation/staff", 1, new ArrayList<MenuInfo>(){{
                    add(new MenuInfo("编辑运维人员",PermissionConst._operation._staff.modify,"",2,null));
                }}));
                add(new MenuInfo("上门取货", PermissionConst._operation._pickup.list, "/operation/pickup", 1, null));
                add(new MenuInfo("运维人员分配", PermissionConst._operation._allow.list, "/operation/allow", 1, new ArrayList<MenuInfo>(){{
                    add(new MenuInfo("分配运维人员",PermissionConst._operation._allow.allow,"",2,null));
                }}));
            }}));
